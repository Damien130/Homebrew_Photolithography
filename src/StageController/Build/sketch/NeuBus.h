#line 1 "D:\\Git\\Homebrew_Photolithography\\src\\StageController\\NeuBus.h"
/*************************************************************
...
class NeuBus
{
    public:
        ...
        void readyToExpose(bool rdyExp);
        void send(uint8_t packet);
        void send(uint16_t packet, volatile bool& ALE);
        void send(uint32_t packet, volatile bool& ALE);
        uint8_t read();
